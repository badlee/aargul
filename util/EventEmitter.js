;!function(undefined) {
    ...
    EventEmitter.prototype.attach = function(object){
      if(object != null && object != undefined){
        object.on = this.on.bind(this);
        object.one = this.once.bind(this);
        object.once = this.once.bind(this);
        object.many = this.many.bind(this);
    ...
    Object.defineProperties(EventEmitter, {
      ...
      attachEmitter: {
        value: function(object){
          if(object != null && object != undefined){
            (new EventEmitter()).attach(object);
          }
        },
        writable: false,
        configurable: true,
    ...
    if (typeof define === 'function' && define.amd) {
      ...
      _global.EventEmitter = EventEmitter.EventEmitter;
    }
  }();