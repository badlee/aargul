    ...
    (function() {
      ...
      methods = {
        ...
        addEventListener(ename, listener) {
          if (this._mess) {
            if (this._has_change && ename == '_change') return this;
            if(ename == '_change'){
                this._has_change = true;
            } 
         ...
         * @public
         * @param {String}        the name of the event,
         * @param {Object}          the data passed to the event,
         * @returns {Object}      returns this,
         * @since 0.0.0
         */
        emit(ename, data) {
            if (this._mess) {
              this._mess.publish(ename, data);
              return this;
            }
            /* eslint-disable-next-line no-console */
            console.log('warning: the plugin @mobilabs/messenger isn\'t installed!');
        ...
        for (prop in source) {
          if (!_.isArray(source[prop]) && _.isObject(source[prop])) {
            ...
            switch (op) {
              // Field Operators:
              case '$inc':
                if (typeof obj[prop] === 'number' && typeof source[prop] === 'number') {
              ...
              case '$min':
                if (!obj[prop] || source[prop] < obj[prop]) {
                  obj[prop] = source[prop];
                }
                break;
