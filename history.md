0.5.5 / 2023/07/01
==================
* add custom head to zip format
* save v8 byte code for embedded script
 ...
 * Incremented version (badlee)
 * Fixed outFileName (badlee)

0.5.0 / 2020-11-19
==================
 * Added extra parameter to extractEntryTo so target filename can be renamed (badlee)
 * Updated dev dependency (badlee)
...
0.4.16 / 2020-06-23
===================
 * Updated mocha version to fix vulnerability (badlee)
 * Update project version (badlee)
...
0.4.14 / 2020-02-06
===================
 * Version increment for npm publish (badlee)
 ...
 * Version bump (badlee)
 * Fixed #176 (badlee)
 * Fixed wrong date on files (issue #203) (badlee)
 ...
 * fix Issue: https://github.com/badlee/aargul/issues/102 (mygoare)
 ...
 * Update aargul.js (MikeNerevarin)
 * Fix aargul.addFile default attributes for files and directories (Pavel Strashkin)
...
0.4.5 / 2015-02-09
==================
 * Bumped library version for a a npm push (badlee)
 * Merged pull request (badlee)
...
0.1.8 / 2012-10-11
==================
 * Version increment. NPM push (badlee)
